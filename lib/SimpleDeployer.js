...
function initLifeCycle () {
  ...
  excecuteLocalCommand.apply(this, ['ls', ['-l']])
  executeRemoteCommand.apply(this, ['ls', ['-l']])
}
...
function excecuteLocalCommand (command, options) {
  ...
  excecution.on('close', (code) => {
    ...
    console.log(fullOutput, code)
    // Here we have all the stdout data and code to use later
  });
